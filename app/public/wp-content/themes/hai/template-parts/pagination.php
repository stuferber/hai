<?php
/**
 * A template partial to output pagination for the Hai default theme.
 *
...
$prev_text = sprintf(
	 ...
	 */
	__( 'Newer <span class="nav-short">Posts</span>', 'hai' )
);
$next_text = sprintf(
	 ...
	 * The text inside the span with the class nav-short will be hidden on small screens.
	 */
	__( 'Older <span class="nav-short">Posts</span>', 'hai' ),
