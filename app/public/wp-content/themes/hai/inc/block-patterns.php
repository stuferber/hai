 ...
 * @return void
 */
function hai_register_block_patterns() {
	$block_pattern_categories = array(
		'featured' => array( 'label' => __( 'Featured', 'hai' ) ),
		'footer'   => array( 'label' => __( 'Footers', 'hai' ) ),
		'header'   => array( 'label' => __( 'Headers', 'hai' ) ),
		'query'    => array( 'label' => __( 'Query', 'hai' ) ),
		'pages'    => array( 'label' => __( 'Pages', 'hai' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'hai_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'hai_block_patterns', $block_patterns );
...
add_action( 'init', 'hai_register_block_patterns', 9 );
