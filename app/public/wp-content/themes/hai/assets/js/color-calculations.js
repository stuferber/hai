 ...
 * @return {Object} - this
 */
function _haiColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_haiColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_haiColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_haiColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _haiColor object.
 *
 * @since Hai 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function haiColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _haiColor( backgroundColor, accentHue );
