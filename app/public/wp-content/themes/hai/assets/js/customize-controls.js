/* global haiBgColors, haiColor, jQuery, wp, _ */
/**
...
( function() {
	...
	wp.customize.bind( 'ready', function() {
		...
		wp.customize( 'accent_hue', function( value ) {
			value.bind( function( to ) {
				...
				Object.keys( haiBgColors ).forEach( function( context ) {
					var backgroundColorValue;
					if ( haiBgColors[ context ].color ) {
						backgroundColorValue = haiBgColors[ context ].color;
					} else {
						backgroundColorValue = wp.customize( haiBgColors[ context ].setting ).get();
					}
					haiSetAccessibleColorsValue( context, backgroundColorValue, to );
				} );
			} );
		} );
	 ...
	 * @return {void}
	 */
	function haiSetAccessibleColorsValue( context, backgroundColor, accentHue ) {
		var value, colors;
		...
		colors = haiColor( backgroundColor, accentHue );
	 ...
	 * @return {void}
	 */
	function haiSetRetineLogoVisibility( visible ) {
